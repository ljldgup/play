...
# 键位映射
keys_map_p1 = {'s': 49, 'a': 74, 'b': 75, 'c': 85, 'd': 73, '6': 68, '4': 65, '2': 83, '8': 87}
keys_map_p2 = {'s': 51, 'a': 84, 'b': 89, 'c': 79, 'd': 80, '6': 78, '4': 86, '2': 66, '8': 71}
...
role_commands['iori'] = [
    ...
    ([2, 3, 6], [0, 0, 3]),
    ([6, 2, 3], [0, 0, 1]),
    ([2, 3, 6, 2, 1, 4], [0, 0, 0, 0, 0, 1]),
]

# 罗伯特出招表
role_commands['robert'] = [
    ([4], [0]),
    # 蹲防
    ([4, 2], [0, 0]),
    # 6c
    ...
    ([4, 1, 2, 3, 6], [0, 0, 0, 0, 2]),
    ([6, 2, 3], [0, 0, 1]),
    ([2, 1, 4, 2, 3, 6], [0, 0, 0, 0, 0, 1]),
]

role = ''


def global_set(chosed_role):
    global role
    role = chosed_role
